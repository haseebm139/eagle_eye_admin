    ...
    <nav class="nav flex-column mt-3">
        <div>
            <a href="{{ route('dashboard') }}" class="nav-link {{ Route::is('dashboard') ? 'active' : '' }}">
                ...
                <svg class=" {{ Route::is('dashboard') ? 'active_hide' : 'active_show' }}" width="24" height="24" viewBox="0 0 24 24" fill="none"
            ...
            <a href="{{ route('orders') }}" class="nav-link {{ Route::is('orders', 'orders.view') ? 'active' : '' }}">
                ...
                <svg width="25" height="24" viewBox="0 0 25 24" fill="none"
                    xmlns="http://www.w3.org/2000/svg" class=" {{ Route::is('orders', 'orders.view') ? 'active_hide' : 'active_show' }}">
                    <path fill-rule="evenodd" clip-rule="evenodd"
            ...
            <a href="{{ route('customers') }}"
                ...
                <svg width="25" height="24" viewBox="0 0 25 24" fill="none" class=" {{ Route::is('customers', 'customers.view') ? 'active_hide' : 'active_show' }}"
                    xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" clip-rule="evenodd"
