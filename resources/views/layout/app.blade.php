					...
					<div class="Messages">
                        <div class="Messages_list">
                            <div class="msg  user1">
                               ...
                               <span class="responsText">fgsg</span>
                            </div>
                            <div class="msg repply">
                               <span class="avtr">
                                name
                               </span>
                               <span class="responsText">hi fgsg, how can i help you?</span>
                            </div>
                            <div class="msg user1">
                                <span class="avtr">
                                    name
                                   </span>
                               <span class="responsText">asdfas</span>
                            </div>
                            <div class="msg repply">
                                <span class="avtr">
                                    name
                                   </span>
                               <span class="responsText">hi asdfas, how can i help you?</span>
                            </div>
                            <div class="msg user1">
                                <span class="avtr">
                                    name
                                   </span>
                               <span class="responsText">asdf</span>
                            </div>
                            <div class="msg repply">
                                <span class="avtr">
                                    name
                                   </span>
                               <span class="responsText">hi asdf, how can i help you?</span>
                            </div>
                         </div>                    </div>
				</div>
				<form id="messenger">
...
<!-- Chatbot -->
	...
	$(document).on("submit", "#messenger", function(e) {
		...
		function userMsg(msg) {
			$('.Messages_list').append('<div class="msg user1"><span class="avtr">name</span><span class="responsText">' + mainval + '</span></div>');
		};
		function appendMsg(msg) {
			$('.Messages_list').append('<div class="msg repply" ><span class="avtr">name</span><span class="responsText">' + msg + '</span></div>');
			$("[name='msg']").val("");
		};
